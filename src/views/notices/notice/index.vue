	...
	<el-container>
		...
		<el-main class="nopadding">
			<scTable ref="table" :apiObj="list.apiObj" row-key="id" @selection-change="selectionChange" stripe>
				...
				<el-table-column label="分类" prop="cate_title" width="180"></el-table-column>
				...
				<el-table-column label="弹窗" prop="status" width="100" sortable='custom' column-key="filterType" :filters="[{text: '启用', value: 1}, {text: '未启用', value: 0}]">
					<template #default="scope">
						<el-switch v-model="scope.row.popup" @change="statusChange(scope.row)" />
					</template>
				</el-table-column>
	...
	export default {
		...
		data() {
			return {
				...
				list: {
					apiObj: this.$API.notice.notice.list
				},
				selection: []
			}
		},
