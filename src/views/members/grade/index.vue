	...
	<el-container>
		...
		<el-main class="nopadding">
			<scTable ref="table" :apiObj="list.apiObj" row-key="id" @selection-change="selectionChange" stripe>
				...
				<el-table-column label="排序" prop="sequence" width="180"></el-table-column>
	...
	export default {
		...
		data() {
			return {
				...
				list: {
					apiObj: this.$API.member.grade.list
				},
				selection: []
			}
		},
		...
		methods: {
			...
			async table_del(row, index){
				...
				var res = await this.$API.member.grade.delete.delete(reqData);
				if(res.code == 20000){
