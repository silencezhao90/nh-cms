		...
		<el-container>
				...
				<el-main class="nopadding">
					<scTable ref="table" :apiObj="apiObj" @selection-change="selectionChange" stripe remoteSort remoteFilter>
						...
						<el-table-column label="登录名" prop="username" width="150" sortable='custom'></el-table-column>
						<el-table-column label="昵称" prop="nickname" width="150" sortable='custom'></el-table-column>
						<el-table-column label="姓名" prop="name" width="150" sortable='custom'></el-table-column>
						<el-table-column label="电话" prop="mobile" width="150" sortable='custom'></el-table-column>
	...
	export default {
		...
		data() {
			return {
				...
				groupFilterText: '',
				group: [],
				apiObj: this.$API.admin.admin.list,
				selection: [],
				search: {
					name: null
				}
