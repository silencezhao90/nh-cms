	...
	<el-container>
		...
		<el-main class="nopadding">
			<scTable ref="table" :apiObj="apiObj" row-key="id" @selection-change="selectionChange" hidePagination>
				...
				<el-table-column label="URL" prop="url" width="250"></el-table-column>
				<el-table-column label="排序" prop="sequence" width="150"></el-table-column>
	...
	export default {
		...
		data() {
			return {
				...
				apiObj: this.$API.admin.permission.listTree,
				selection: [],
				search: {
					keyword: null
				}
