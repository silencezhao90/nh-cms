	...
	<el-main>
		<el-card shadow="never">
			<el-form :model="form" :rules="rules" :disabled="mode=='show'" ref="form" label-width="100px" style="align-items: start">
				...
				<el-form-item v-show="form.type == 10 || form.type == 50" label="内容" prop="html" style="height: 500px; width: 450px;align-items:start">
					<div style="border: 1px solid #ccc">
						...
						/>
						<Editor
							style="height: 400px; overflow-y: hidden; width: 450px;"
