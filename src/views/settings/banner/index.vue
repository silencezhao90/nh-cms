	...
	<el-container>
		...
		<el-main class="nopadding">
			<scTable ref="table" :apiObj="list.apiObj" row-key="id" @selection-change="selectionChange" stripe>
				...
				<el-table-column label="简介" prop="intro" width="180"></el-table-column>
				<el-table-column label="网页URL" prop="web_url" width="180"></el-table-column>
				<el-table-column label="小程序URL" prop="applet_url" width="180"></el-table-column>
